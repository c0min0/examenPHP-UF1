      ...
      <ul class="navbar-nav ms-md-auto gap-2">
        ...
        <li class="nav-item dropdown rounded">
          ...
          // Ex5
            ...
            <li><a class="dropdown-item " href="list-users.php"><strong>Admin:</strong> Llistar usuaris</a></li>
            <li><a class="dropdown-item " href="close-account.php"><strong style="color:red">Perill!</strong> Eliminar compte</a></li>
